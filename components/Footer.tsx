      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div>
            ...
            >
              <div className="w-10 h-10 bg-itot-teal rounded-full flex items-center justify-center">
                 <svg viewBox="0 0 109.39 122.88" className="w-6 h-6 fill-white">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              <li><a href="https://www.okademy.africa" target="_blank" rel="noopener noreferrer" className="hover:text-teal-400 transition-colors">Okademy (Formation)</a></li>
              <li><Link to="/solutions" onClick={handleNav} className="hover:text-teal-400 transition-colors">Développement Software</Link></li>
              <li><Link to="/solutions" onClick={handleNav} className="hover:text-teal-400 transition-colors">Conseil Stratégique</Link></li>
              <li><Link to="/solutions" onClick={handleNav} className="hover:text-teal-400 transition-colors">E-learning Platforms</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              <li><Link to="/" onClick={handleNav} className="hover:text-teal-400 transition-colors">Accueil</Link></li>
              <li><Link to="/about" onClick={handleNav} className="hover:text-teal-400 transition-colors">À Propos</Link></li>
              <li><Link to="/impact" onClick={handleNav} className="hover:text-teal-400 transition-colors">Impact & Études</Link></li>
              <li><Link to="/partnerships" onClick={handleNav} className="hover:text-teal-400 transition-colors">Partenariats</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-6 text-slate-400">
              ...
              <li className="flex gap-4">
                ...
                <a href="https://wa.me/243978400415" target="_blank" rel="noopener noreferrer" className="hover:text-teal-400 transition-colors">
                  +243 978 400 415
                </a>
              </li>
              <li className="flex gap-4">
        ...
        <div className="pt-10 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-slate-500">
          ...
          <div className="flex gap-8">
            <Link to="/legal" onClick={handleNav} className="hover:text-white transition-colors">Mentions Légales</Link>
            <Link to="/privacy" onClick={handleNav} className="hover:text-white transition-colors">Confidentialité</Link>
          </div>
        </div>
      </div>
    </footer>
